...
if (isset($_SESSION['accountID'])) {
        ...
        if ($error === 0) {
            if ($img_size > 1250000) {
                ...
                if (in_array($img_ex_lc, $allowed_exs)) {
                    ...
                    $stmt = $db->prepare("UPDATE faculty SET img_url = :img_url WHERE accountID = :accountID AND role='admin'");
    ...
    if ($stmt->rowCount() > 0) {
        ...
        header("Location: ../admin/index.php?message=Edit successfully!");
    } else {
        echo "No rows were updated.";
        header("Location: ../admin/index.php?message=Edit unsuccessful!");
    }
