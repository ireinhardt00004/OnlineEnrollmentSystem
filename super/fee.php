...
<head>
    ...
    <title>List of School Fees</title>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Insert SCHOOL FEES</h4>
      ...
      <div class="modal-body-centered">
        ...
        <form id="insert-subject"  method="post" action="insertfee.php" enctype="multipart/form-data">
          <!-- Form inputs -->
          ...
          <div class="form-group">
            <label for="subjectYear">Academic Year:</label>
          ...
          <div class="form-group">
            <label for="subjectSemester">Academic Semester:</label>
          ...
          <div class="form-group">
            <label for="subjectCode">Name of the Fee:</label>
            <input type="text" class="form-control" name ="pay_name" placeholder="Enter subject code">
          </div>
          <div class="form-group">
            <label for="subjectName">Fee Description:</label>
            <input type="text" class="form-control" name="price_description" placeholder="Enter Name">
          </div>
          <div class="form-group">
            <label for="subjectName">Price:</label>
            <input type="number" class="form-control" step="any" name="price"placeholder="Enter Price">
       ...
       <!-- IT -->
<div>
    <button class="btn btn-primary" id="insert-btn" data-toggle="modal" data-target="#myModal"style="float:right;">INSERT SCHOOL FEES</button></div><br><hr>
    <div>
        <?php if (isset($_GET['msg'])) { ?>
         ...
         <?php
            ...
            $query = "SELECT COUNT(*) AS total FROM subject WHERE subject_department = 'Bachelor of Science in Information Technology'";
    ...
    <table class="table">
        ...
        $query = "SELECT * FROM fee WHERE fee_department ='Bachelor of Science in Information Technology'";
        ...
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            $html .= "<td><a href='deleteFee.php?fee_id={$row['fee_id']}' class='btn btn-danger'onclick='return confirmDelete()'>Delete Fee</a></td>";
            $html .= "</tr>";
        }
        ?>
        <thead>
        <tr>
            ...
            <th scope="col">Name of the Fee</th>
...
<!-- BM -->
    ...
    <table class="table">
        <h2>BUSINESS MANAGEMENT&nbsp;&nbsp;(Total Number=&nbsp;<?php echo $totalIT; ?></h2><br>
        
        <?php
        // Retrieve subject details and apply sorting
        $query = "SELECT * FROM fee WHERE fee_department ='Bachelor of Science in Business Management'";
        $result = $db->query($query);
...
<hr>
    ...
    <table class="table">
        <h2>HOSPITALITY MANAGEMENT&nbsp;&nbsp;(Total Number=&nbsp;<?php echo $totalIT; ?></h2><br>
        
        <?php
        // Retrieve subject details and apply sorting
        $query = "SELECT * FROM fee WHERE fee_department ='Bachelor of Science in Hospitality Management'";
        $result = $db->query($query);
