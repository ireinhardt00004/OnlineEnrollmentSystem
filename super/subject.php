...
<div>
    ...
    <table class="table">
        ...
        $query = "SELECT * FROM subject WHERE subject_department ='Bachelor of Science in Information Technology'";
        ...
        while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
            ...
            $html .= "<td>{$row['lab']}</td>";
            $html .= "<td><a href='deleteSubject.php?subject_id={$row['subject_id']}' class='btn btn-danger' onclick='return confirmDelete()'>Delete</a></td>";
            $html .= "</tr>";
        }
        ?>
        <thead>
...
<div>
               <?php
                    ...
                    // Retrieve the total number of Subject BM
            $query = "SELECT COUNT(*) AS total FROM subject WHERE subject_department = 'Bachelor of Science in Business Management'";
            $stmt = $db->prepare($query);
            $stmt->execute();
    ...
    <table class="table">
        ...
        // Retrieve subject details and apply sorting
        $query = "SELECT * FROM subject WHERE subject_department ='Bachelor of Science in Business Management'";
        $result = $db->query($query);
...
<div>           <?php
            ...
            $query = "SELECT COUNT(*) AS total FROM subject WHERE subject_department = 'Bachelor of Science in Hospitality Management'";
            $stmt = $db->prepare($query);
            $stmt->execute();
    ...
    <table class="table">
        ...
        <?php
        // Retrieve subject details and apply sorting
        $query = "SELECT * FROM subject WHERE subject_department ='Bachelor of Science in Hospitality Management'";
        $result = $db->query($query);
